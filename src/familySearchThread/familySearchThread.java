...
import ThreadPool.addNeoThread;
 ...
 * 
 */
public class familySearchThread implements Runnable {
  private static Logger logger = Logger.getLogger(familySearchThread.class);

  private family_dao family_dao = new family_dao(); // 亲属的dao
  private sysdao sysdao = new sysdao();
  private ArrayList jtgxs = null;
  private String cqtype = "";

  public familySearchThread(ArrayList jtgxs, String cqtype) {
    this.jtgxs = jtgxs;
    this.cqtype = cqtype;
  }
